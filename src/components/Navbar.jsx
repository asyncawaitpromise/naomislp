      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800 group-hover:text-teal-700 transition-colors duration-300">
                Naomi's Speech Therapy
              </h1>
              <p className="text-xs text-gray-600 hidden sm:block">Specialized Cleft Palate Care</p>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              to="/contact"
              className="ml-4 px-6 py-2 bg-gradient-to-r from-teal-600 to-blue-700 text-white rounded-lg font-semibold hover:from-teal-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg"
            >
